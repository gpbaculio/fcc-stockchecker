...
suite('Functional Tests', function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield suite('GET /api/stock-prices => stockData object', function () {
            return __awaiter(this, void 0, void 0, function* () {
                const stock = 'goog';
                ...
                test('1 stock with like', function (done) {
                    chaiModule
                        ...
                        assert.isTrue(result.likes === 1, // new stock, increase like 1,
                ...
                test('1 stock with like again (ensure likes arent double counted)', function (done) {
                    chaiModule
                        ...
                        assert.isTrue(result.likes === 0, // new stock decreased, to be unliked if already liked from same ip address
